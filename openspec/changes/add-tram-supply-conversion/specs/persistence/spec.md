...
- **WHEN** a v4 save from game year 1896 without a converter station is loaded by a v5 build
- **THEN** the loaded state has tram conversion phase `due` (year ≥ dueYear) and no converter station
